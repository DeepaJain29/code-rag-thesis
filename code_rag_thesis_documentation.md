...
Fixed-size chunking → code embedding model → top-k cosine similarity retrieval → LLM generation. No graph, no structure. Cheapest, weakest baseline — establishes the floor.
